		...
		if(user == null || verificaruser.length == 0 || verificarpass.lenght == 0 || pass == null){
			...
			<div class="loginbox">
				...
				<div class="input-group mt-5 mb-5">
					...
					<input class="form-control" type="password" name="pass" id="Pass" placeholder="Ingrese su ContraseÒa" onselectstart="return false" onCut="return false" onCopy="return false" onpaste="return false" onDrop="return false" onDrag="return false" autocomplete=off required>
				</div>
				<div align="center">
